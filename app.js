    ...
    User.find({_id:req.session.passport.user},function(err, user) {
        ...
        if(user[0]!=undefined) {
            var user_info = {
                ...
                generalJob: user[0].general_job,
                specificJob: user[0].specific_job,
                topskills: user[0].skills,
                summary: user[0].summary,
                workImages: user[0].workimages,
...
app.post('/updateprofile',function(req,res) {
    User.findOne({_id: req.session.passport.user},function(err,user) {
        ...
        if(req.body.generalJob!=null && req.body.generalJob!=undefined) {
            console.log(req.body.generalJob)
            user.general_job = req.body.generalJob;
        }
        ...
        if(req.body.workImages!=null && req.body.workImages!=undefined) {
            console.log(req.body.workImages)
            user['workimages'] = req.body.workImages;
        }
